...
namespace RunNow.ViewModels
{
    ...
    {
        private readonly IAuthService _authService; //  추가
        ...
        //  생성자 수정: IAuthService 주입 추가
        public MainWindowViewModel(NavigationStore navigationStore, IServiceProvider serviceProvider, IAuthService authService)
        {
            _navigationStore = navigationStore;
            _serviceProvider = serviceProvider;
            _authService = authService; //  추가
