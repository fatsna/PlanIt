...
namespace RunNow.ViewModels
{
    public partial class RegisterViewModel : ObservableObject
    {
            ...
            IServiceProvider serviceProvider)
        {
            ...
            SelectedPhonePrefix = PhonePrefixes.First();
        }
        ...
        private static DupIdStatus ParseDupStatus(JObject resp)
        {
            ...
            return code switch
            {
                "3_1" => DupIdStatus.Available,
                "3_2" => DupIdStatus.Taken,
        ...
        [ObservableProperty] private bool isFaceRegistered;
        ...
        public List<string> PhonePrefixes { get; } = new() { "010", "011", "016", "017", "018", "019" };

        [ObservableProperty, NotifyCanExecuteChangedFor(nameof(SubmitCommand))]
        private string selectedPhonePrefix;
        ...
        public string PhoneNumber => $"{SelectedPhonePrefix}{PhonePart2}{PhonePart3}";
